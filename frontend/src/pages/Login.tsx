    ...
    <div className="max-w-md mx-auto py-12 px-4">
      <div className="glass-card rounded-2xl p-8 border border-slate-800 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-white">Administrator & User Login</h2>
          <p className="text-xs text-slate-400">Sign in to access the Admin Control Panel or manage reports</p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="sunil.reddyk06@gmail.com"
