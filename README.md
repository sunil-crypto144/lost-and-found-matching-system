...
▶️ **[Click Here to Watch the Demo Video](DEMO/lost_and_found_demo.mov)** *(Plays directly in GitHub)*
...
- [Demo Video](DEMO/lost_and_found_demo.mov) — 5-minute video walkthrough in DEMO folder.
